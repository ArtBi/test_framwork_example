...
public class PetApiService extends BaseApiService {
    ...
    public AssertableResponse getPetById(Integer petId) {
        ...
        AssertableResponse response =
                get(PET_ENDPOINT + "/{petId}", Map.of("petId", petId.toString()), Map.of());
    ...
    public AssertableResponse updatePet(PetPayload pet) {
        log.info(
                "Updating pet with ID: {}, name: {}, status: {}",
                pet.getId(),
                pet.getName(),
                pet.getStatus());
    ...
    public AssertableResponse deletePet(Integer petId) {
        ...
        AssertableResponse response =
                delete(PET_ENDPOINT + "/{petId}", Map.of("petId", petId.toString()));
    ...
    public AssertableResponse findPetsByStatus(String status) {
        ...
        AssertableResponse response =
                get(PET_ENDPOINT + "/findByStatus", Map.of(), Map.of("status", status));
    ...
    public AssertableResponse updatePetStatus(PetCreationResponse pet, String status) {
        log.info(
                "Updating pet status for pet ID: {}, name: {}, new status: {}",
                pet.getId(),
                pet.getName(),
                status);
        AssertableResponse response =
                post(
                        PET_ENDPOINT + "/{petId}",
                        Map.of("petId", pet.getId().toString()),
