 ...
 * Copyright (c) 2025
 */
package com.github.artbi.api.petstore.containers;
...
/**
 * Container for the Swagger Petstore API. This container runs the Swagger
 * Petstore Docker image and exposes port 8080.
 */
@Slf4j
public class PetstoreContainer extends GenericContainer<PetstoreContainer> {
    ...
    public PetstoreContainer() {
        ...
        waitingFor(Wait.forHttp("/api/v3/openapi.json").forStatusCode(200).withStartupTimeout(Duration.ofMinutes(2)));
    }

    /**
     * Gets a singleton instance of the Petstore container. Thread-safe
